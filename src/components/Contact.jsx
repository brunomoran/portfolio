...
const socialLinks = [
  ...
  {
    href: "https://github.com/brunomoran",
    icon: (
      <svg
        width="24"
        height="24"
...
const Contact = () => {
  return (
    <section id="contact" className="section mb-64">
      <div className="container lg:grid lg:grid-cols-1 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <div className="flex items-center gap2 mt-auto reveal-up">
            {socialLinks.map((socialLink, index) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-900 active:bg-zinc-50/80 reveal-up
                        "
              >
                {socialLink.icon}
              </a>
            ...
            <ButtonPrimary
              href="mailto:bruno.moranvivanco@gmail.com"
              label="bruno.moranvivanco@gmail.com"
              icon="email"
              classes="reveal-up"
            />
          </div>
